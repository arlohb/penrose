...
// ignore params and return pairs of window ID and index in the client vec
#[cfg(test)]
...
/// A simple monocle layout that places uses the maximum available space for the focused client and
